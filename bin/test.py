...
#sp = my_planet.get_existing_building( 'spaceport', <ID from copy above> )
#print( sp.image )
#quit()
### 
### ...OR, much nicer...
...
### Run the "Build new" block abov first, then copy the building ID from its 
### output and paste it as the second arg to get_existing_building() below.
#sp = my_planet.get_existing_building( 'spaceport', 4734912 )
...
#sp = my_planet.get_existing_building_coords( 2, -3 )
#sp.do_downgrade()
...
#sp = my_planet.get_existing_building_coords( -3, 0 )
