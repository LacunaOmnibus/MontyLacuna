...
# -*- coding: utf-8 -*-
#
# MontyLacuna documentation build configuration file, created by
...
project = 'Monty Lacuna'
copyright = '2014 - 2015, Jonathan Barton'
...
htmlhelp_basename = 'MontyLacunadoc'
...
latex_documents = [
  ('index', 'MontyLacuna.tex', 'MontyLacuna Documentation',
...
man_pages = [
    ('index', 'montylacuna', 'MontyLacuna Documentation',
     ['Jonathan Barton'], 1)
]
...
texinfo_documents = [
  ('index', 'MontyLacuna', 'MontyLacuna Documentation',
   'Jonathan Barton', 'MontyLacuna', 'One line description of project.',
   'Miscellaneous'),
]
